...
public class CuentaUSD extends Cuenta implements IServicioTransaccion, MostrarInfo {
    ...
    public boolean retirar(double cantidad) {
        if (cantidad > 0) {
            if (getSaldo() >= cantidad) {
                ...
                System.out.println("Error: Saldo insuficiente para retirar " + cantidad + " dólares.");
                return false;
            }
        } else {
